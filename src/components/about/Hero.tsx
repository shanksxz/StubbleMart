    ...
    return (
        <div className="w-full font-raleway relative">
            ...
            <div className="relative z-[5] flex flex-col items-start justify-center h-[500px] translate-y-[-70px] sm:translate-y-0  w-[90%] gap-4 mx-auto">
                ...
                <p className=" text-[#CFCFCF] font-semibold  text-[25px] w-[70%] md:w-[60%]">Join the green <span className=' text-primary-green'>Revolution</span>  by turning agricultural waste into valuable resources for a cleaner , tech-driven future.</p>

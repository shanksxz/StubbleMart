...
export default function Hero() {
    return (
        <div className="w-full font-raleway relative">
            ...
            <div className="relative z-10 flex flex-col w-full lg:w-[60%] xl:w-[50%] px-4 sm:px-6 md:px-8 lg:px-20 justify-center min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] gap-4">
                <h1 className="font-bold text-white text-3xl sm:text-4xl md:text-5xl lg:text-[50px] leading-tight">
                ...
                <p className="text-slate-300 text-lg sm:text-xl md:text-2xl lg:text-[25px]">
